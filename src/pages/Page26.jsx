  ...
  return (
    <>
      ...
      <main className="p-6 space-y-4">
        <h1 className="text-3xl font-bold text-indigo-800">Tradair Feature 26</h1>
        <section className="bg-white shadow rounded p-4">
          <p className="text-gray-700 leading-relaxed">
            This page demonstrates feature 26 of the Tradair app. It is fully styled using Tailwind CSS
