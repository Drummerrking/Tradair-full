...
export default function RateDelivery({ requestId }) {
  ...
  return (
    <div className="bg-white p-4 rounded shadow mt-4">
      ...
      <select className="border p-1 mb-2" value={rating} onChange={(e) => setRating(Number(e.target.value))}>
      ...
      <textarea className="w-full border p-2 mb-2" rows="3" value={review} onChange={(e) => setReview(e.target.value)} />
